  ...
  if (done) return (
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--bg)' }}>
      <div className="text-center max-w-sm">
        ...
        <h2 className="text-xl font-[650] mb-2">Check your email</h2>
        <p className="text-sm" style={{ color: 'var(--t3)' }}>We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.</p>
        <Link href="/login" className="inline-block mt-6 text-sm font-[550]" style={{ color: '#9DB1F2' }}>Back to sign in</Link>
      </div>
    </div>
  )
    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--bg)' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl p-8" style={{ background: 'var(--s1)', boxShadow: 'inset 0 0 0 1px var(--line2)' }}>
          <h1 className="text-[22px] font-[650] tracking-tight mb-1">Create account</h1>
          <p className="text-sm mb-8" style={{ color: 'var(--t3)' }}>Start managing your pipeline</p>
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-4">
            ...
            <label>
              <div className="text-[12.5px] font-[550] mb-2" style={{ color: 'var(--t2)' }}>Password</div>
            ...
            <button type="submit" disabled={loading}
              className="w-full py-3 rounded-[10px] font-[600] text-[14px] text-white transition-all mt-2"
          ...
          <p className="text-center text-[13px] mt-6" style={{ color: 'var(--t3)' }}>
            ...
            <Link href="/login" className="font-[550]" style={{ color: '#9DB1F2' }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
