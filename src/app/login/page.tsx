    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ background: 'var(--bg)' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl p-8" style={{ background: 'var(--s1)', boxShadow: 'inset 0 0 0 1px var(--line2)' }}>
          <h1 className="text-[22px] font-[650] tracking-tight mb-1">Welcome back</h1>
          <p className="text-sm mb-8" style={{ color: 'var(--t3)' }}>Sign in to your CRM account</p>
          ...
          <p className="text-center text-[13px] mt-6" style={{ color: 'var(--t3)' }}>
            No account?{' '}
            <Link href="/register" className="font-[550]" style={{ color: '#9DB1F2' }}>Create one</Link>
          </p>
        </div>
      </div>
    </div>
